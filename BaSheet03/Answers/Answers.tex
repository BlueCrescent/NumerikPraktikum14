...
\begin{figure} [htbp]
    \subfigure[Plot of approximation]{\includegraphics[width=0.50\textwidth]{../Task16/sh3_task16_convergence_plot_rw.pdf}} 
    \subfigure[Estimation error]{\includegraphics[width=0.50\textwidth]{../Task16/sh3_task16_convergence_plot_bb.pdf}} 
