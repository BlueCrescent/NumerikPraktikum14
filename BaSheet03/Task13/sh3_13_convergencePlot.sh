...
plot "data_s3_13_d=1" using 1:2 with l title "Monte Carlo", \
 ...
 "data_s3_13_d=1" using 1:5 with l title "Product - Clensha Curtis", \
 "data_s3_13_d=1" using 1:6 with l title "Sparse Grid - Trapez", \
 "data_s3_13_d=1" using 1:7 with l title "Sparse Grid - Clensha Curtis"
pause mouse
...
plot "data_s3_13_d=2" using 1:2 with l title "Monte Carlo", \
 ...
 "data_s3_13_d=2" using 1:5 with l title "Product - Clensha Curtis", \
 "data_s3_13_d=2" using 1:6 with l title "Sparse Grid - Trapez", \
 "data_s3_13_d=2" using 1:7 with l title "Sparse Grid - Clensha Curtis"
pause mouse
...
plot "data_s3_13_d=4" using 1:2 with l title "Monte Carlo", \
 ...
 "data_s3_13_d=4" using 1:5 with l title "Product - Clensha Curtis", \
 "data_s3_13_d=4" using 1:6 with l title "Sparse Grid - Trapez", \
 "data_s3_13_d=4" using 1:7 with l title "Sparse Grid - Clensha Curtis"
pause mouse
...
plot "data_s3_13_d=8" using 1:2 with l title "Monte Carlo", \
 ...
 "data_s3_13_d=8" using 1:5 with l title "Product - Clensha Curtis", \
 "data_s3_13_d=8" using 1:6 with l title "Sparse Grid - Trapez", \
 "data_s3_13_d=8" using 1:7 with l title "Sparse Grid - Clensha Curtis"
pause mouse
