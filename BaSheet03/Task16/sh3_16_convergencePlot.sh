...
plot "data_s3_16_d=1" using 1:2 with l title "RandWalk - Monte Carlo", \
 ...
 "data_s3_16_d=1" using 1:11 with l title "BrownBridge - Product - Clensah Curtis", \
 "data_s3_16_d=1" using 1:12 with l title "BrownBridge - Sparse Grid - Trapez", \
 "data_s3_16_d=1" using 1:13 with l title "BrownBridge - Sparse Grid - Clensah Curtis"
pause mouse
...
plot "data_s3_16_d=2" using 1:2 with l title "RandWalk - Monte Carlo", \
 ...
 "data_s3_16_d=2" using 1:11 with l title "BrownBridge - Product - Clensah Curtis", \
 "data_s3_16_d=2" using 1:12 with l title "BrownBridge - Sparse Grid - Trapez", \
 "data_s3_16_d=2" using 1:13 with l title "BrownBridge - Sparse Grid - Clensah Curtis"
pause mouse
...
plot "data_s3_16_d=4" using 1:2 with l title "RandWalk - Monte Carlo", \
 ...
 "data_s3_16_d=4" using 1:11 with l title "BrownBridge - Product - Clensah Curtis", \
 "data_s3_16_d=4" using 1:12 with l title "BrownBridge - Sparse Grid - Trapez", \
 "data_s3_16_d=4" using 1:13 with l title "BrownBridge - Sparse Grid - Clensah Curtis"
pause mouse
...
plot "data_s3_16_d=8" using 1:2 with l title "RandWalk - Monte Carlo", \
 ...
 "data_s3_16_d=8" using 1:11 with l title "BrownBridge - Product - Clensah Curtis", \
 "data_s3_16_d=8" using 1:12 with l title "BrownBridge - Sparse Grid - Trapez", \
 "data_s3_16_d=8" using 1:13 with l title "BrownBridge - Sparse Grid - Clensah Curtis"
pause mouse
